...
echo "Assemble the source file calculator.asm"
nasm -f elf64 -l avg.lis -o cal.o calculator.asm

echo "Compile the source file driver.c"
gcc  -m64 -Wall -no-pie -o driver.o -std=c2x -c driver.c

echo "Link the object modules to create an executable file"
gcc -m64 -no-pie -o calc.out cal.o driver.o -std=c2x -Wall -z noexecstack
